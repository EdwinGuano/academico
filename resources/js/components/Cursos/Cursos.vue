<template>
  <div>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr v-for="curs in cursos.data" :key="curs.id">
    ...
    <div class="col-4 md-4 text-right text-primary">
     Registro desde:{{cursos.from}}- Hasta{{cursos.to}} /Total:{{cursos.total}}
    ...
    <div class="col-7 md-7">
      <nav> 
                  <ul class="pagination">
                    ...
                    <li class="page-item" :class="{disabled:pagination.page==cursos.last_page}"><a href="#" class="page-link"  @click="pagination.page++; listar();">&gt;</a></li>
                    <li class="page-item" :class="{disabled:pagination.page==cursos.last_page}"><a href="#" class="page-link"  @click="pagination.page=cursos.last_page; listar();">&raquo;</a></li>
                  </ul>
              </nav>    
...
export default {
  ...
  methods: {
    ...
    async listar() {
      const res = await axios.get('http://127.0.0.1:8000/api/curso', {params: this.pagination });
    ...
    listarPaginas(){
      ...
      if(fin>this.cursos.last_page){
        fin=this.cursos.last_page
      } 
