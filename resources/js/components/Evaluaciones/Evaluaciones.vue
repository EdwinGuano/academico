                                            ...
                                            <tr v-for="(matricula, index) in lista_matriculas">
                                                ...
                                                <td 
                                                    ...
                                                    <input 
                                                        ...
                                                        @keyup="GuardarNota(matricula.alumno_id, matricula.periodo_id, materia_id, plan.detalplanevas[0].id, $event.target.value);"
...
export default {
    ...
    methods: {
        ...
        async abrirRegistro(asignadoc)
        {
            ...
            let url = 'http://127.0.0.1:8000/api/evaluacion/planificacion/'+ parametros;
        ...
        async buscardata()
        {
            const resdoc = await axios.get('http://127.0.0.1:8000/api/evaluacion', {
                params: {
        ...
        GuardarNota(alumno_id, periodo_id, materia_id, detalplaneva_id, nota_deteva)
        {
            ...
            let url = "http://127.0.0.1:8000/api/evaluacion/guadar/nota";
