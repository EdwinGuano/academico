                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <v-select v-model="alumno.especialidad" :items= "espe" item-text="nom_especialidad" item-value="id" dense solo id="especialidad" required></v-select>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <label for="">Reparto:</label>
                                <div v-if="message_validation.reparto_id != ''" v-text='message_validation.reparto_id' class="text-danger"></div>
                                <v-select v-model="alumno.reparto" :items= "repa" item-text="nom_reparto" item-value="id" dense solo id="reparto" required></v-select>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <v-select v-model="alumno.grado" :items= "grad" item-text="nom_grado" item-value="id" dense solo id="grado" required="required"></v-select>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <label for="">Tipo de Sangre</label>
                                <div v-if="message_validation.tiposangre_id != ''" v-text='message_validation.tiposangre_id' class="text-danger"></div>
                                <v-select v-model="alumno.sangre" :items= "sang" item-text="nom_sangre" item-value="id" dense solo id="sangre" required></v-select>
                            </div>
                        </div> 
                          <!-- Modal footer -->
  ...
  methods: {
    ...
    async guardar()
    {
        if(this.modificar)
        {
            ...
            let url = 'http://127.0.0.1:8000/api/alumno/'+ this.id;
        ...
        else
        {
            ...
            let url = 'http://127.0.0.1:8000/api/alumno/';
