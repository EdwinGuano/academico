  ...
  <div>
    ...
    <div class="my-4">
        ...
        <div class="input-group mb-3">
            ...
            <input v-model="buscar" type="text" v-on:keyup.enter="buscardata();" class="form-control" id="buscar" placeholder="Buscar Nombre y Apellido Alumno (Presione enter)">
                        ...
                        <div v-if="vperiodo">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <v-select v-model="matricula.periodo" :items= "per" item-text="peri_per" item-value="id" dense solo id="id" ></v-select>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    <label for="seccion">Sección</label>
                                    <div v-if="message_validation.seccion_id != ''" v-text='message_validation.seccion_id' class="text-danger"></div>
                                    <v-select v-model="matricula.seccion" :items= "secc" item-text="nom_sec" item-value="id" dense solo id="id"></v-select> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <v-select v-model="matricula.curso" :items= "cur" item-text="nom_cur" item-value="id" dense solo id="id" ></v-select>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <input type="date" v-model="matricula.feins_matri" class="form-control" required>
                                </div>
                            </div>
                        </div>  
                        <div v-else>
...
export default {
  ...
  methods: {
    async listar() {
      ...
      const resper = await axios.get('http://127.0.0.1:8000/api/listar/periodo');
      ...
      console.log(this.verperi);
        ...
        async guardar()
        {
            if(this.modificar)
            {
                ...
                let url = 'http://127.0.0.1:8000/api/matricula/' + this.id;
            ...
            else
            {
                ...
                let url = 'http://127.0.0.1:8000/api/matricula/';
