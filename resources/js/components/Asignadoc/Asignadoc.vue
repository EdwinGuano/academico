  ...
  <div>
    ...
    <div class="my-4">
        ...
        <div class="input-group mb-3">
            ...
            <input v-model="buscar" type="text" v-on:keyup.enter="buscardata();" class="form-control" id="buscar" placeholder="Buscar Nombre y Apellido Docente (Presione enter)">
...
export default {
  ...
  methods: {
        async listar() {
            ...
            const resperi = await axios.get('http://127.0.0.1:8000/api/listar/periodo');
            ...
            const resporcentaje = await axios.get('http://127.0.0.1:8000/api/porcentajes');
      ...
      this.listar();
        ...
        async guardar() 
        {
            if(this.modificar)
            {
                ...
                let url = 'http://127.0.0.1:8000/api/asignadoc/'+ this.id;
            ...
            else
            {
                ...
                let url = 'http://127.0.0.1:8000/api/asignadoc/';
