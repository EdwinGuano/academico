...
export default {
    ...
    methods: {
        ...
        async descargar()
        {
           // window.open('http://127.0.0.1:8000/reporte/cursos/descargar/'+ this.curso_id +'/'+ this.periodo_id);
             $('#viePDF').attr('src', 'http://127.0.0.1:8000/reporte/cursos/descargar/'+ this.curso_id +'/'+ this.periodo_id);
