...
Route::group(['middleware' => 'docente'], function(){
    ...
    Route::get('/reporte/registro-notas/descargar/{curso_id}/{materia_id}/{periodo_id}', [App\Http\Controllers\Web\ReporteController::class, 'registroNotaDescargar'])->name('web');
});
...
Route::group(['middleware' => 'estudiante'], function(){
    ...
    Route::get('/reporte/notas/descargar/{curso_id}/{periodo_id}', [App\Http\Controllers\Web\ReporteController::class, 'notasDescargar'])->name('web');
});
...
Route::group(['middleware' => 'tecnico'], function(){
    ...
    Route::get('/reporte/matriculas/descargar/{curso_id}/{periodo_id}', [App\Http\Controllers\Web\ReporteController::class, 'matriculasDescargar'])->name('web');

    Route::get('/reporte/cursos', [App\Http\Controllers\Web\ReporteController::class, 'cursos'])->name('web');
    Route::get('/reporte/cursos/descargar/{curso_id}/{periodo_id}', [App\Http\Controllers\Web\ReporteController::class, 'cursosDescargar'])->name('web');
});
